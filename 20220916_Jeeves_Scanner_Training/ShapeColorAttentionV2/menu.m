...
params.runNum = 7; % What number run are we at? Starts at 0 because the while loop below increments this

% Reward parameters
params.rewardDur = 0.03; % Seconds of reward
...
params.endGrayDur = 9; % Seconds, how long gray is on at end of experiment
params.choiceDistAngle = 10; % Degrees Visual Angle, how distant the choices will be 
params.stimDur = 4; % TRs, how many TRs the stimulus will be on
...
params.probeChance = 2/3; % The chance that it is a probe trial
