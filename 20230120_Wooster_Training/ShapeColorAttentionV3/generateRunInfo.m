function [params] = generateRunInfo(params)
    ...
    ChoiceLocation = strings(params.numblocks,1); ChoiceLocation(params.probeArray) = choices_withNone(params.sideChoices + 1)'; % Chosen location
    ...
    ChoiceStimuli_prep = choiceStimuli_withNone(sub2ind(size(choiceStimuli_withNone),rows,columns)); % What were the chosen stimuli
    ChoiceStimuli = strings(params.numblocks,1); ChoiceStimuli(params.probeArray) = ChoiceStimuli_prep;
