...
params.grayDur = .5; % TRs, how many TRs the gray will be after the stimulus
...
while true % Now we run a while loop to actually display the menu
    if params.runNum > 1
        ...
        disp("disabled concat for testing stuff this session, please remove comment above if doing normal stuff")
    end
