...
runLog(:,3) = 1./(params2change.calibration.log(:,8)+params2change.calibration.log(:,9));
runLog(:,4) = params2change.calibration.log(:,6);
runLog(:,5) = params2change.calibration.log(:,7);
runLog(:,6) = params2change.calibration.log(:,10);
runLog(:,7) = params2change.calibration.log(:,4);
runLog(:,8) = params2change.calibration.log(:,5);
...
params.run.fixation.isDotOn          = params2change.calibration.log(end,4);
params.run.fixation.isGridOn         = params2change.calibration.log(end,10);
params.run.fixation.coordinates      = [];
params.run.fixation.isInWindow       = params2change.calibration.log(end,5);
