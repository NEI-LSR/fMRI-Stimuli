function [ax, hlines] = Multiplot(set1, set2, set3, ylabels)
    
    % MULTIPLOT - Extends plotyy to include a third y-axis and allows the
    ...
    % [ax,hlines] = Multiplot({x1,y1,x2,y2,x3,y3,x1,y4},{x1,y5},{x1,[y6,y7]},ylabels);
    ...
    ax(1).Position = pos;
    ax(2).Position = pos;
    pos3 = [pos(1) pos(2) pos(3)+offset pos(4)]; % Determine the position of the third axes
    limx1 = ax(1).XLim;                          % Determine the proper x-limits for the third axes
