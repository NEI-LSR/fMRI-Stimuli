...
params.runNum = 15; % What number run are we at? Starts at 0 because the while loop below increments this

% Reward parameters
params.rewardDur = 0.02; % Seconds of reward
params.rewardWait = 1.3; % Seconds, time to wait between rewards
