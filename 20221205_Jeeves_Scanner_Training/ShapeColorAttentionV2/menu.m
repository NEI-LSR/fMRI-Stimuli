...
params.rewardWait = 0.75; % Seconds, time to wait between rewards
...
params.rewardWaitJitter = 0.05; % Seconds, jitter in how much reward is given by at any moment
...
params.xOffset = -1428; % Pixels
params.yOffset = -739; % Pixels
