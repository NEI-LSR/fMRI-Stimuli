...
params.runNum = 18; % What number run are we at? Starts at 0 because the while loop below increments this
...
params.blockrepeats = 5; % Number of times blocks are repeated
...
params.probeChance = 1/2; % The chance that it is a probe trial
