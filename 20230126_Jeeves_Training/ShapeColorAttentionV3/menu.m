...
% Reward parameters
params.rewardDur = 0.006; % Seconds of reward
params.rewardWait = .6; % Seconds, time to wait between rewards
...
params.choiceRewardDur = 0.125; % Seconds, how long the reward is for correct choice
...
params.stimDur = 1; % TRs, how many TRs the stimulus will be on
