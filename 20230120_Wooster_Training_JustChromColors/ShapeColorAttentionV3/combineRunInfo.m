function [params] = combineRunInfo(params)
    ...
    groupsummary(resultTable(resultTable.Complete==1 & resultTable.ProbeTrial==true,:),["Blocktype","Stimulus"],["mean","sum"],'Correct')
    
    disp('Summary of performance by blocktype')
    groupsummary(resultTable(resultTable.Complete==1 & resultTable.ProbeTrial==true,:),"Blocktype",["mean","sum"],'Correct')
