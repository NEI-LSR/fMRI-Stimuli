function [params] = LoadParameters()
    ...
    params.datapixx.calibrationGain      = [50 50];                                                                                    % Eye tracker calibration voltage gain      ([X Y] axes)
    params.datapixx.calibrationSign      = [-1 1];                                                                                     % Eye tracker calibration voltage inversion ([X Y] axes)
    
    
    %% Directories
    subjectID                            = 'Langston';                                                                                 % Monkey's name
    ...
    params.display.viewingDistance       = 31.0;%18;                                                                                       % In cm
    params.display.size                  = [59.2 33.3];%[74.7 42.0];%[50.4 28.4];%[88.9 50.0];                                                                                % In cm
    ...
    params.run.exactDuration             = 522;                                                                                        % In seconds
    ...
    params.run.fixation.windowSize       = 8;                                                                                          % In degrees
    ...
    params.run.reward.startFrequency     = 8.0;                                                                                        % In Hz
    params.run.reward.minFrequency       = 2.0;                                                                                        % In Hz
    params.run.reward.maxFrequency       = 4.0;                                                                                        % In Hz
