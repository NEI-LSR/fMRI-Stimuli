function ALZ_dyLocX_standard_BW_NIF_2022(subj_id, counterbalance_idx, acquisition_num)
...
stim_dir = 'C:\Users\duffieldsj\Documents\dyloc_stimuli\';

KbName('UnifyKeyNames'); 


CONDITION_NAMES ={'Fruit','Fruit_bw','Fruit_scrambled','Fruit_scrambled_bw'}
STIM_SUB_DIRS = {fullfile(stim_dir,CONDITION_NAMES{1}), fullfile(stim_dir,CONDITION_NAMES{2}), fullfile(stim_dir, CONDITION_NAMES{3}), fullfile(stim_dir, CONDITION_NAMES{4})}

%CONDITION_NAMES ={'Faces','Bodies', 'Scenes','Objects','Scrambled15G','Faces_bw','Bodies_bw','Scenes_bw','Objects_bw','Scrambled15GBW',};% threw out bodies!
%STIM_SUB_DIRS = {fullfile(stim_dir,CONDITION_NAMES{1}), fullfile(stim_dir, CONDITION_NAMES{2}), fullfile(stim_dir, CONDITION_NAMES{3}), fullfile(stim_dir, CONDITION_NAMES{4}), fullfile(stim_dir, CONDITION_NAMES{5}), fullfile(stim_dir, CONDITION_NAMES{6}), fullfile(stim_dir, CONDITION_NAMES{7}), fullfile(stim_dir, CONDITION_NAMES{8}), fullfile(stim_dir, CONDITION_NAMES{9}), fullfile(stim_dir, CONDITION_NAMES{10})};
...
%            0 5 6 2 8 4 0 9 3 7 1 10 0 10 1 7 3 9 0 4 8 2 6 5 0;
%            0 6 2 8 4 10 0 5 9 3 7 1 0 1 7 3 9 5 0 10 4 8 2 6 0;
%            0 2 8 4 10 1 0 6 5 9 3 7 0 7 3 9 5 6 0 1 10 4 8 2 0;
%            0 8 4 10 1 7 0 2 6 5 9 3 0 3 9 5 6 2 0 7 1 10 4 8 0;
%            0 4 10 1 7 3 0 8 2 6 5 9 0 9 5 6 2 8 0 3 7 1 10 4 0;
%            0 10 1 7 3 9 0 4 8 2 6 5 0 5 6 2 8 4 0 9 3 7 1 10 0;];
