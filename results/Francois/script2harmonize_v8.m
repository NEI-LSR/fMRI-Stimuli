...
params.run.startTime                 = [str2double(params2change.calibration.startTime(1:4)) str2double(params2change.calibration.startTime(5:6)) str2double(params2change.calibration.startTime(7:8)) str2double(params2change.calibration.startTime(10:11)) str2double(params2change.calibration.startTime(12:13)) str2double(params2change.calibration.startTime(14:15))];
...
clear endIdx fixWinSize idx key runLog subjectID params2change;
