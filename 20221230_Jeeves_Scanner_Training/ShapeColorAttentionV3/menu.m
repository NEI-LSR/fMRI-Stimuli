...
params.xGain = -1700; % Pixels/Volt
params.yGain = 2445; % Pixels/Volt
params.xOffset = -1085; % Pixels
params.yOffset = -1723; % Pixels
...
params.blockrepeats = 12; % Number of times blocks are repeated
