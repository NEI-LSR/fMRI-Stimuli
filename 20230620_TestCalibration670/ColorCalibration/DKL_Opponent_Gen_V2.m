...
scalingFs = [0.95 0.95 0.95 0.95 0.95 0.95]; % How far along the gamut of the direction with the least gamut range do you want to extend?
angles = [0 90 180 270 0 0]; % What angles in DKL space do you want to compute your colors around
lumAngles = [0 0 0 0 90 -90]; % What angle along the LMS axis do you want to calculate around?
