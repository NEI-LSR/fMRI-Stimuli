    ...
    try
        ...
        for frameIdx = 1:fps*exactDur
            ...
            if rem(frameIdx,jitterFrames) == 1
                ...
                viewStimRect = CenterRectOnPointd(baseRect, round(xCenter+jitterX(i)), round(yCenter+jitterY(i)));
                expStimRect = CenterRectOnPointd(baseRect, round(xCenterExp+jitterX(i)), round(yCenterExp+jitterY(i)));
            end
