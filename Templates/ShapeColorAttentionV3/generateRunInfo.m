function [params] = generateRunInfo(params)
    ...
    writetable(table(median_dist_TR,'VariableNames',{['IMA' num2str(IMA)]}),params.eyeTraceDistanceDMSaveFile,'Delimiter',',');
    writetable(table(fixation_TR,'VariableNames',{['IMA' num2str(IMA)]}),params.eyeTraceFixationDMSaveFile,'Delimiter',',');
