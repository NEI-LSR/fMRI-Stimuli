function [params] = SC(params)
    ...
    params.gray = [31 29 47]; % The gray of the background. Very important!
    ...
    params.fixUpperRightRect = CenterRectOnPointd(params.baseRect*1.5,xCenterExp+params.horzDist,yCenterExp-params.vertDist); % Create upper FixRect choice rectangle (Index 1, clockwise)
    params.fixLowerRightRect = CenterRectOnPointd(params.baseRect*1.5,xCenterExp+params.horzDist,yCenterExp+params.vertDist); % Create lower right choice rectangle (Index 2, clockwise)
    params.fixLowerLeftRect = CenterRectOnPointd(params.baseRect*1.5,xCenterExp-params.horzDist,yCenterExp+params.vertDist); % Create lower left choice rectangle (Index 3, clockwise)
    params.fixUpperLeftRect = CenterRectOnPointd(params.baseRect*1.5,xCenterExp-params.horzDist,yCenterExp-params.vertDist); % Create upper left choice rectangle (Index 4, clockwise)
        ...
        % Begin Stimulus
            ...
            if keyIsDown == 1
                ...
                elseif keyCode(KbName('w')) && params.fixPix > params.pixPerAngle/2 % Increase params.fixation circle
                    ...
                    params.fixUpperLeftRect = CenterRectOnPointd(params.baseRect*2,xCenterExp-params.horzDist,xCenterExp+params.vertDist); % Create upper left choice rectangle (Index 4, clockwise)
                    params.fixRects = {params.fixUpperRightRect,params.fixLowerRightRect,params.fixLowerLeftRect,params.fixUpperLeftRect}; % Cell array of params.fixation choice rects, this needs to be repeated later in the main code for updating
