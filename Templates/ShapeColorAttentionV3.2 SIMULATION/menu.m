...
trials = 200; %Set number of simulated trials here
...
%DAQ('Debug',false); %DAQ NOT SUPPORTED on MAC
%DAQ('Init');
...
% Screen information
params.expscreen = 0; % Experimenter's Screen
...
params.endGrayDur = 0.01; % Seconds, how long gray is on at end of experiment
params.startGrayDur = 0.01; % Seconds, how long gray is on at start of experiment
...
params.TR = 0.01; % Seconds, how many TRs 
