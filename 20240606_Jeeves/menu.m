...
% Reward parameters
params.rewardDur = 0.005; % Seconds of reward
params.rewardWait = 2.25; % Seconds, time to wait between rewards
...
params.xGain = -1665; % Pixels/Volt
params.yGain = 490; % Pixels/Volt
params.xOffset = -119.3921; % Pixels
params.yOffset = -939.0194; % Pixels
params.xChannel = 3; % DAQ indexes starts at 1
params.yChannel = 2; % Where y channel inputs to the DAQ
...
params.use_index = [1,4,5,8,9,12,13]; %[2,3,6,7,10,11,14];
