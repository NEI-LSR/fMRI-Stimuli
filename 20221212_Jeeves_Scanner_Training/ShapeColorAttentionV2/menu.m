...
% Reward parameters
params.rewardDur = 0.010; % Seconds of reward
...
params.rewardWaitJitter = 0; % Seconds, jitter in how much reward is given by at any moment
params.rewardPerf = 0.87; % % Fixation, how much to get reward
...
params.xGain = 1705; % Pixels/Volt
params.yGain = 2025; % Pixels/Volt
params.xOffset = -1145; % Pixels
params.yOffset = -1434; % Pixels
...
params.pixPerAngle = 40; % Number of pixels per degree of visual stimuli (SJD 2022-12-06 -- The actua number of pixels per degree is 50, but kept at this point for consistency.)
...
params.choiceRewardDur = 0.05; % Seconds, how long the reward is for correct choice
...
params.blockrepeats = 10; % Number of times blocks are repeated
