...
% Reward parameters
params.rewardDur = 0.007; % Seconds of reward
...
params.xOffset = -792; % Pixels
params.yOffset = -1530; % Pixels
...
params.choiceRewardDur = 0.2; % Seconds, how long the reward is for correct choice
